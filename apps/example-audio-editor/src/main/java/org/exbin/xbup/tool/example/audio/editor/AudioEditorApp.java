 ...
 */
package org.exbin.xbup.tool.example.audio.editor;
...
/**
 * The main class of the example audio editor application.
 *
 * @author ExBin Project (https://exbin.org)
 */
@ParametersAreNonnullByDefault
public class AudioEditorApp {

    private AudioEditorApp() {
    }
    ...
    public static void main(String[] args) {
        AddonApplication app = AddonApplication.createApplication(AudioEditorApp.class);
        app.init();
        App.launch(() -> {
