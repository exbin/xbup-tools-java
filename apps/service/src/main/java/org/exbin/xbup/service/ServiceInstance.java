...
public class ServiceInstance {
    ...
    public void run() {
        Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("service_head"));
        Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
        ...
        try {
            ...
            Logger.getLogger(ServiceInstance.class.getName()).log(Level.SEVERE, "{0}{1}: {2}", new Object[]{resourceBundle.getString("error_warning"), resourceBundle.getString("error_tcpip_port"), tcpipPort});
        }

        Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "{0} {1}:{2}...", new Object[]{resourceBundle.getString("init_service"), tcpipInterface, Integer.toString(tcpipPortInt)});
        ...
        serviceServer.setCatalogProvider(new XBTCPServiceServer.CatalogProvider() {
            ...
            public XBACatalog createCatalog() {
                if (catalog == null) {
                    ...
                    ServiceInstance.this.createCatalog();
                }
        ...
        try {
            ...
            serviceServer.run();
            Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "{0}.", resourceBundle.getString("stop_service_success"));
        } catch (IOException e) {
            Logger.getLogger(ServiceInstance.class.getName()).log(Level.WARNING, "{0}: {1}", new Object[]{resourceBundle.getString("init_service_failed"), e});
        }
    }

    private void initCatalog() {
        Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "{0}...", resourceBundle.getString("init_catalog"));
        try {
            derbyMode = false;
    ...
    private void performUpdate() {
        ...
        try {
            Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
            Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("init_service_success"));
            Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
            if (shallUpdate) {
                // TODO: Should be threaded
                Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("init_update"));
                Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
                ...
                Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
                Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, resourceBundle.getString("done_update"));
                Logger.getLogger(ServiceInstance.class.getName()).log(XBCatalogNetServiceServer.XB_SERVICE_STATUS, "");
            }
        } catch (XBProcessingException ex) {
            Logger.getLogger(ServiceInstance.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
