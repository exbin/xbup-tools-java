...
/**
 * The main class of the example text application.
 *
...
public class TextEditorApp {
    ...
    public static void main(String[] args) {
        BasicApplication app = BasicApplication.createApplication(TextEditorApp.class);
        app.init();
        App.launch(() -> {
            ...
            app.addModulesFromManifest(TextEditorApp.class);
            app.initModules();

            App.launch("org.exbin.xbup.tool.example.text.launcher.TextEditorLauncherModule", args);
        });
    }
}
