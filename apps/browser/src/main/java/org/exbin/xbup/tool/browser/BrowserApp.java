...
public class BrowserApp {
    ...
    public static void main(String[] args) {
        BasicApplication app = BasicApplication.createApplication(BrowserApp.class);
        app.init();
        App.launch(() -> {
            ...
            app.addModulesFromManifest(BrowserApp.class);
            app.initModules();

            App.launch("org.exbin.xbup.tool.browser.launcher.BrowserLauncherModule", args);
        });
    }
}
