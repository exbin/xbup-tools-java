 ...
 */
package org.exbin.jaguif.editor.xbup.text;
...
public class XBTextDocument extends TextDocument {
    ...
    public XBLFormatDecl getContextFormatDecl() {
        ...
        XBPSerialReader reader = new XBPSerialReader(getClass().getResourceAsStream("/org/exbin/jaguif/editor/xbup/text/resources/xbt_format_decl.xb"));
