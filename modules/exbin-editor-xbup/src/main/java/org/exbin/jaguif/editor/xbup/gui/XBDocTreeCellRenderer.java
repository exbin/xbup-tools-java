 ...
 */
package org.exbin.jaguif.editor.xbup.gui;
...
public class XBDocTreeCellRenderer extends DefaultTreeCellRenderer {
    ...
    public XBDocTreeCellRenderer() {
        super();
        dataBlockIcon = new ImageIcon(getClass().getResource("/org/exbin/jaguif/editor/xbup/resources/icons/data-block-16x16.png"));
    }
