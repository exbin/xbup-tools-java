...
import org.exbin.xbup.jaguif.editor.gui.XBDocStatusPanel;
...
public class StatusPanelHandler {
    ...
    public XBDocStatusPanel getDocStatusPanel() {
        if (docStatusPanel == null) {
            ...
            frameModule.registerStatusBar(XbupEditorModule.MODULE_ID, XbupEditorModule.DOC_STATUS_BAR_ID, docStatusPanel);
            frameModule.switchStatusBar(XbupEditorModule.DOC_STATUS_BAR_ID);
