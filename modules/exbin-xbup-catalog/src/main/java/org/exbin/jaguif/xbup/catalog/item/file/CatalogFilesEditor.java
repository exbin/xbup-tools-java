 ...
 */
package org.exbin.jaguif.xbup.catalog.item.file;
...
import org.exbin.jaguif.xbup.catalog.item.file.action.AddFileAction;
import org.exbin.jaguif.xbup.catalog.item.file.action.DeleteFileAction;
import org.exbin.jaguif.xbup.catalog.item.file.action.RenameFileAction;
import org.exbin.jaguif.xbup.catalog.item.file.action.ReplaceFileContentAction;
import org.exbin.jaguif.xbup.catalog.item.file.action.SaveFileContentAsAction;
import org.exbin.jaguif.xbup.catalog.item.file.gui.CatalogFilesTableModel;
import org.exbin.jaguif.xbup.catalog.item.file.gui.CatalogItemEditFilesPanel;
...
//                return node != null && node.getParent().isPresent();
    ...
    public void initActions() {
        saveFileContentAsAction.init();
        replaceFileContentAction.init();
    }
