...
import org.exbin.jaguif.viewer.xbup.gui.GeneralPropertiesPanel;
...
public class PropertiesViewer implements BlockViewer {
    ...
    public Optional<ImageIcon> getIcon() {
        return Optional.of(new javax.swing.ImageIcon(getClass().getResource("/org/exbin/jaguif/viewer/xbup/resources/icons/open_icon_library-standard/icons/png/16x16/actions/tooloptions.png")));
    }
