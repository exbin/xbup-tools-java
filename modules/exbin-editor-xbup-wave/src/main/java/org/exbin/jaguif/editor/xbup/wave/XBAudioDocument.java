 ...
 */
package org.exbin.jaguif.editor.xbup.wave;
...
public class XBAudioDocument extends AudioDocument {
    ...
    public XBLFormatDecl getContextFormatDecl() {
        ...
        XBPSerialReader reader = new XBPSerialReader(getClass().getResourceAsStream("/org/exbin/jaguif/editor/xbup/wave/resources/xbs_format_decl.xb"));
