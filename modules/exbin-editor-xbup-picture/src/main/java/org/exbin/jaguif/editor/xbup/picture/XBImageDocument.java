 ...
 */
package org.exbin.jaguif.editor.xbup.picture;
...
public class XBImageDocument extends ImageDocument {
    ...
    public XBLFormatDecl getContextFormatDecl() {
        ...
        XBPSerialReader reader = new XBPSerialReader(getClass().getResourceAsStream("/org/exbin/jaguif/editor/xbup/picture/resources/xbp_format_decl.xb"));
