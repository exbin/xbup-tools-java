...
public class XBDocumentPanel extends javax.swing.JPanel {
    ...
    private List<XbupViewerPage> blockViewers = new ArrayList<>();
    ...
    public void addBlockViewer(XbupViewerPage blockViewer) {
    ...
    private void viewerChanged(int blockViewerIndex) {
        if (blockViewerIndex >= 0) {
            XbupViewerPage blockViewer = blockViewers.get(blockViewerIndex);
    ...
    @Nonnull
    public Optional<XbupViewerPage> getActiveViewer() {
