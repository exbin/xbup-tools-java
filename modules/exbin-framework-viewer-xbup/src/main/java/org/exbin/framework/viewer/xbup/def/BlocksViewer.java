...
import org.exbin.framework.viewer.xbup.gui.BlocksTableCellEditor;
import org.exbin.framework.viewer.xbup.gui.BlocksTableCellRenderer;
...
public class BlocksViewer {
    ...
    private void init() {
        ...
        toolBarManager.buildIconToolBar(viewerPanel.getToolBar(), TOOLBAR_ID, actionManager);
