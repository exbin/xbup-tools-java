...
import org.exbin.framework.document.text.service.TextSearchService;
...
public class TextualViewer implements BlockViewer {
    ...
    public Optional<ImageIcon> getIcon() {
        return Optional.of(new javax.swing.ImageIcon(getClass().getResource("/org/exbin/framework/viewer/xbup/resources/icons/open_icon_library-standard/icons/png/16x16/actions/format-text-smallcaps.png")));
    }
