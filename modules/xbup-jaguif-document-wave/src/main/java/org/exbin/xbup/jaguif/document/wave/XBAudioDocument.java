 ...
 */
package org.exbin.xbup.jaguif.document.wave;
...
public class XBAudioDocument extends AudioDocument {
    ...
    public void loadFrom(DocumentSource documentSource) {
        if (documentSource instanceof FileDocumentSource) {
            ...
            if (fileType != null && XbupDocumentWaveModule.XBS_FILE_TYPE.equals(fileType.getFileTypeId())) {
                try {
    ...
    public XBLFormatDecl getContextFormatDecl() {
        ...
        XBPSerialReader reader = new XBPSerialReader(getClass().getResourceAsStream("/org/exbin/xbup/jaguif/document/wave/resources/xbs_format_decl.xb"));
