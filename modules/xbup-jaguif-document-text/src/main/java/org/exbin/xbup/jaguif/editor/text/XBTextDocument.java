 ...
 */
package org.exbin.xbup.jaguif.editor.text;
...
public class XBTextDocument extends TextDocument {
    ...
    public XBLFormatDecl getContextFormatDecl() {
        ...
        XBPSerialReader reader = new XBPSerialReader(getClass().getResourceAsStream("/org/exbin/xbup/jaguif/editor/text/resources/xbt_format_decl.xb"));
